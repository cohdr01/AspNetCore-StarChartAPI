...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var celestialObects = _context.CelestialObjects.Where(e => e.Id == id || e.OrbitedObjectId == id);
            if (!celestialObects.Any())
                return NotFound();
            _context.CelestialObjects.RemoveRange(celestialObects);
            _context.SaveChanges();
            return NoContent();
        }
    }
